...
use crate::engine::{Color, GameResult};
...
impl Game {
  ...
  // validate the move for current turn
  pub fn valid_move(
    &self,
    move_str: &String,
    ...
    let chess_move = match parse_san_move(&self.board, move_str) {
    ...
    Ok(self.board.is_legal_move(chess_move, self.get_turn_color()))
  }
