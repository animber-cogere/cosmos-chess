...
impl From<(Addr, u64)> for RatingSummary {
  fn from(tuple: (Addr, u64)) -> Self {
    RatingSummary {
      player: tuple.0.to_string(), // Convert Addr to String, adjust according to your Addr definition
      rating: tuple.1,
    }
  }
}